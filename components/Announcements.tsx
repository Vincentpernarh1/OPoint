...
const AnnouncementList = memo(({ announcements, currentUser, onDelete }: { announcements: Announcement[], currentUser: User, onDelete?: (id: string) => void }) => {
        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className={canPost ? "lg:col-span-2" : "lg:col-span-3"}>
                    <AnnouncementList announcements={announcements} currentUser={currentUser} onDelete={onDelete} />
                </div>
            </div>
        </>
    );
