...
// FIX: Add optional title prop to fix type errors and for accessibility.
...
export const CheckSquareIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const LayoutDashboardIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const MapPinIcon = ({ className = 'h-6 w-6', title }: IconProps) => (
...
export const CameraIcon = ({ className = 'h-6 w-6', title }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        {title && <title>{title}</title>}
...
export const ChevronLeftIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const CheckCircleIcon = ({ className = 'h-6 w-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
);

export const DollarSignIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const TrendingUpIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const TrendingDownIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const ArrowUpRightIcon = ({ className = 'h-6 w-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M7 17V7h10"/><path d="M7 7 17 17"/></svg>
);

export const ArrowDownLeftIcon = ({ className = 'h-6 w-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M17 7v10H7"/><path d="m17 7-10 10"/></svg>
);
...
// Roadmap Features Icons
export const FileTextIcon = ({ className = 'h-6 w-6' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13"></line><line x1="16" x2="8" y1="17" y2="17"></line><line x1="10" x2="8" y1="9" y2="9"></line></svg>
);

export const MegaphoneIcon = ({ className = 'h-6 w-6' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m3 11 18-5v12L3 14v-3z"></path><path d="M11.6 16.8a3 3 0 0 1-5.8-1.6"></path></svg>
);

export const ReceiptIcon = ({ className = 'h-6 w-6' }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"></path><path d="M16 8h-6a2 2 0 1 0 0 4h6"></path><path d="M12 17.5v-11"></path></svg>
);

export const UserCircleIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const SmartphoneIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
// B2B Admin Icons
export const BuildingOfficeIcon = ({ className = 'h-6 w-6' }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 21h18"/><path d="M7 21V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v16"/><path d="M11 21V11a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v10"/><path d="M15 7h0"/><path d="M11 7h0"/><path d="M7 7h0"/></svg>
);
...
export const EyeIcon = ({ className = 'h-6 w-6' }: IconProps) => (
...
export const EyeOffIcon = ({ className = 'h-6 w-6' }: IconProps) => (
